...
import { follow, unFollow, setCurrentPage, setUsers, toggleIsFetching } from "../../redux/users-reducer";
...
export default connect(mapStateToProps, {follow, unFollow, setUsers, setCurrentPage, toggleIsFetching})(UsersAPI);